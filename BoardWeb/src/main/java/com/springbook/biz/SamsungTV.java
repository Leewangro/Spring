...
/*
 * public class SamsungTV implements TV { private Speaker speaker; private int
 * price;
 * 
 * public SamsungTV() { System.out.println("====>삼성티비(1) 객체 생성"); } public
 * SamsungTV(Speaker speaker) { System.out.println("====>삼성티비(2) 객체 생성");
 * this.speaker = speaker; }
 * 
 * public SamsungTV(Speaker speaker, int price) {
 * System.out.println("====>삼성티비(3) 객체 생성"); this.speaker = speaker; this.price
 * = price; }
 * 
 * public void powerOn() { System.out.println("삼성티비 ----전원 켠다. (가격 : " + price +
 * ")"); }
 * 
 * public void powerOff() { System.out.println("삼성티비 ----전원 끈다."); }
 * 
